...
public class LaunchUnitTest {
    ...
    @DisplayName("setPlayLoad should not be empty")
    @Test
    public void setPlayLoadShouldNotBeEmpty() {

        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> launch.setPayload(Collections.emptySet()));
        assertEquals("Payloads set cannot be empty", exception.getMessage());
